      ...
      <div className="container-fluid">
        <div className="d-flex align-items-center">
          ...
          <div className="d-flex align-items-center mx-2">
            ...
            <button className="ms-2" style={{ border: "none",borderRadius: "10px",backgroundColor: "#6d6d81", color: "white",padding: "2px 10px"}}> 
              Admin
            </button>
          </div>
        </div>
        ...
        <div className="d-flex align-items-center">
          ...
          <NavLink to={"/logout"}>
            <span style={{ color: "black", fontSize: "16px", cursor: "pointer" }}> 
