   ...
   const handleFileChange = (e) => {
    ...
    return(
        <Container   className="pt-5">
            <Row className="pt-5">
                <Col lg={6} className="p-3 my-1  d-flex  justify-content-center align-item-center">
                                    ...
                                    <Col col md={6}>
                                        <Row>
                                            <Col md={12} className=" p-2 ">
                                                ...
                                                <Row style={{textAlign:"center",}} className=" p-2">
                                                    <Col md={12} style={{borderRadius:'10px'}}className="border border-primary  mt-1 p-2 align-items-center shadow">
                                    ...
                                    <Row style={{textAlign:"center",}} className=" p-1">
                                     ...
                                     <Row style={{textAlign:"center",}}>
                                          <Col md={12} className="mt-1 pt-1">
                                            <h6 className="text-success" style={{/*color:"#0573e9",*/fontSize:"16px"}}> To view and download result
